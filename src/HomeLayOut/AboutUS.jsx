...
const AboutUs = () => {
  return (
    ...
    <ul className="space-y-4">
            <li className="flex items-start gap-3"><FaCar className="text-gray-600 text-xl" />
            <p className="text-gray-700">Wide range of vehicles for every trip</p>
            </li>

            <li className="flex items-start gap-3">
     <FaLock className="text-gray-600 text-xl" /><p className="text-gray-700">Safe and verified vehicle owners</p>
            </li>

            <li className="flex items-start gap-3">
     <FaCalendarAlt className="text-gray-600 text-xl" /><p className="text-gray-700">Real-time availability & easy booking</p>
            </li>

            <li className="flex items-start gap-3">
    <FaStar className="text-gray-600 text-xl" /><p className="text-gray-700">Trusted by travelers for reliability</p>
            </li>
          </ul>
        </div>
